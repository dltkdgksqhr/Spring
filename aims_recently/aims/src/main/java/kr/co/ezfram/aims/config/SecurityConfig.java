...
import kr.co.ezfram.aims.jwt.JwtAccessDeniedHandler;
import kr.co.ezfram.aims.jwt.JwtAuthenticationEntryPoint;
import kr.co.ezfram.aims.jwt.JwtSecurityConfig;
import kr.co.ezfram.aims.jwt.TokenProvider;
 ...
 /*   @Override
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/testa/**").permitAll()		// 차트를 위한 api
    ...
    */
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://localhost:8031");
